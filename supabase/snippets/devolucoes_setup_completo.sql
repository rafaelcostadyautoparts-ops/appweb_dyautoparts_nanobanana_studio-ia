-- DY Auto Parts - configuracao completa do modulo de devolucoes marketplace

-- Fonte: supabase\migrations\20260702000100_devolucoes_marketplace.sql
create table if not exists public.devolucoes (
    ...
    tarifa_devolucao_reembolsada numeric(14,2) not null default 0,
...
begin
    ...
    insert into public.devolucoes (
        ...
        case when coalesce((p_devolucao->>'marketplace_acionado')::boolean, false) then 'em_analise' else 'resolvida' end,
...
-- Fonte: supabase\migrations\20260703000100_devolucoes_acompanhamento_marketplace.sql
...
-- Fonte: supabase\migrations\20260703000200_devolucoes_saldo_marketplace.sql
alter table public.devolucoes
...
-- Fonte: supabase\migrations\20260703000300_devolucoes_atualizar_saldo.sql
create or replace function public.atualizar_acompanhamento_devolucao(
    p_id uuid,
    p_marketplace_acionado boolean,
    p_observacao text,
...
-- Fonte: ajuste app 2026-07-08 - reembolso de tarifa de devolucao ML
alter table public.devolucoes
    add column if not exists tarifa_devolucao_reembolsada numeric(14,2) not null default 0;
...
grant execute on function public.atualizar_acompanhamento_devolucao(uuid, boolean, text, numeric, numeric)
    to anon, authenticated, service_role;


-- Fonte: supabase\migrations\20260710000100_devolucoes_reputacao_revertida.sql

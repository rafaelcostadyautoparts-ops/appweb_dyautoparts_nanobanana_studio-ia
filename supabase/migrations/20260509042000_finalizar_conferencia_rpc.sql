CREATE INDEX IF NOT EXISTS idx_estoque_atual_id_interno_local
    ON public.estoque_atual (id_interno, local);

CREATE INDEX IF NOT EXISTS idx_separacao_itens_separacao_id
    ON public.separacao_itens (separacao_id);

CREATE INDEX IF NOT EXISTS idx_conferencia_separacao_id
    ON public.conferencia (separacao_id);

CREATE INDEX IF NOT EXISTS idx_conferencia_itens_conferencia_id
    ON public.conferencia_itens (conferencia_id);

CREATE INDEX IF NOT EXISTS idx_movimentos_id_interno_data_hora

-- Migration: Correção Transacional de Chaves Estrangeiras na Alocação Definitiva de Separação
-- Resolve o erro 23503 preservando 100% das constraints originais sem alteração estrutural nas tabelas.
-- Cria primeiro a entidade pai com o ID definitivo, clona os pacotes sob o novo pai,
-- migra os itens dos pacotes e itens avulsos, migra tabelas filhas dinamicamente se existirem e finalmente remove o rascunho.
...
IS 'Gera atomicamente com advisory lock o numero oficial definitivo de separacao exclusivamente no momento da finalizacao com migracao transacional segura e dinamica de rascunhos e pacotes.';

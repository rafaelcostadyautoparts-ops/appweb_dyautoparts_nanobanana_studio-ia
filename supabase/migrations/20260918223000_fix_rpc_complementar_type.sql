-- Migration: 20260918223000_fix_rpc_complementar_type.sql
-- Descricao: Ajusta a RPC finalizar_recebimento_entrada_nf para conversao explicita complementar_id::text em COALESCE

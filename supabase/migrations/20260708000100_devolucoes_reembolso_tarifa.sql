-- DY Auto Parts - reembolso de tarifa de devolucao marketplace
-- Aplica o campo usado pelo app para gravar valores estornados pelo ML.

alter table public.devolucoes
    add column if not exists tarifa_devolucao_reembolsada numeric(14,2) not null default 0;

comment on column public.devolucoes.tarifa_devolucao_reembolsada
    is 'Valor de tarifa/custo de devolucao reembolsado pelo marketplace no financeiro.';

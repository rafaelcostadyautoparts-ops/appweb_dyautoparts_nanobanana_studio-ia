-- Migration: 20260918210000_finalizar_recebimento_entrada_nf_financeiro.sql
-- Descricao: Atualiza a RPC finalizar_recebimento_entrada_nf para incluir a efetivacao atoma do financeiro (promocao de contas_pagar de rascunho para pendente)
